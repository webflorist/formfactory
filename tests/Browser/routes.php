...
Route::get('vue-success', '\FormFactoryTests\Browser\Controllers\VueFormTestController@getSuccess');
Route::post('vue-success', '\FormFactoryTests\Browser\Controllers\VueFormTestController@postSuccess');

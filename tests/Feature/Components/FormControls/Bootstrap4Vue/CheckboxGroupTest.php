            ...
            '
                <fieldset class="form-group">
                    ...
                    <div class="form-check" v-bind:class="{ \'has-error\': fieldHasError(\'myFirstCheckboxFieldName\') }">
                        <input type="checkbox" name="myFirstCheckboxFieldName" value="1" id="myFormId_myFirstCheckboxFieldName" aria-describedby="myFormId_myFirstCheckboxFieldName_errors" v-model="fields[\'myFirstCheckboxFieldName\'].value" v-bind:required="fields[\'myFirstCheckboxFieldName\'].isRequired" v-bind:disabled="fields[\'myFirstCheckboxFieldName\'].isDisabled" v-bind:aria-invalid="fieldHasError(\'myFirstCheckboxFieldName\')" />

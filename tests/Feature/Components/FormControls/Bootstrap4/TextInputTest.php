        ...
        $this->assertHtmlEquals(
            '
                <div class="form-group">
                    ...
                    <input type="text" name="myFieldName" class="form-control is-invalid" id="myFormId_myFieldName" required pattern="[a-zA-Z]+" maxlength="10" placeholder="MyFieldName" aria-describedby="myFormId_myFieldName_errors myFormId_myFieldName_helpText" aria-invalid="true" />

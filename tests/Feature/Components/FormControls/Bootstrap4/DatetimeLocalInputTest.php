        ...
        $this->assertHtmlEquals(
            '
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="myFieldName" class="form-control is-invalid" id="myFormId_myFieldName" required aria-describedby="myFormId_myFieldName_errors myFormId_myFieldName_helpText" aria-invalid="true" />

...
class DatetimeLocalInputElement extends \Nicat\HtmlBuilder\Elements\DatetimeLocalInputElement implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

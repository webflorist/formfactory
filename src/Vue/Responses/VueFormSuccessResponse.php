...
class VueFormSuccessResponse extends VueFormResponse
{
    ...
    public function __construct($message = null, int $status = 200)
    {
        ...
        $this->vueFormResponseData['message'] = $message ?? trans('Nicat-FormFactory::formfactory.default_success_message');
    }
    ...
    {
        $this->vueFormResponseData['message'] .= ' ' . trans('Nicat-FormFactory::formfactory.redirect_message');

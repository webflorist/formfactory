...
use Nicat\HtmlBuilder\Components\DateInputComponent;

class DateInput extends DateInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

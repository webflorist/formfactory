    ...
    extends DivElement
{
    ...
    protected function beforeDecoration()
    {
        ...
        foreach ($this->content->getChildrenByClassName(FieldInterface::class) as $childKey => $child) {
            /** @var FieldInterface|FormControlInterface|FieldTrait|FormControlTrait|HelpTextInterface|HelpTextTrait|LabelInterface|LabelTrait $child */
    ...
    protected function afterChildrenDecoration()
    {
        ...
        parent::afterChildrenDecoration(); // TODO: Change the autogenerated stub
    }

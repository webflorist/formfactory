...
use Nicat\HtmlBuilder\Components\RangeInputComponent;

class RangeInput extends RangeInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

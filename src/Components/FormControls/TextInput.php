...
use Nicat\HtmlBuilder\Components\TextInputComponent;

class TextInput extends TextInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

...
use Nicat\HtmlBuilder\Components\DatetimeInputComponent;

class DatetimeInput extends DatetimeInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

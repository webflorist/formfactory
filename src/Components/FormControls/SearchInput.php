...
use Nicat\HtmlBuilder\Components\SearchInputComponent;

class SearchInput extends SearchInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

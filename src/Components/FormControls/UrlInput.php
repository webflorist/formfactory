...
use Nicat\HtmlBuilder\Components\UrlInputComponent;

class UrlInput extends UrlInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

...
use Nicat\HtmlBuilder\Components\EmailInputComponent;

class EmailInput extends EmailInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

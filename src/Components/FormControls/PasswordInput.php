...
use Nicat\HtmlBuilder\Components\PasswordInputComponent;

class PasswordInput extends PasswordInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,

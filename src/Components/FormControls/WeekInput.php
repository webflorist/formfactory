...
use Nicat\HtmlBuilder\Components\WeekInputComponent;

class WeekInput extends WeekInputComponent implements FieldValueProcessorInterface, AutoTranslationInterface
{
    use CanHaveLabel,
        CanHaveRules,
        CanHaveHelpText,
